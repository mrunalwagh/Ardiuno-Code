...
#define Apple_time 35
#define Sandwich_time 16
#define Orange_time 37
#define Hotdog_time 12
#define Pizza_time 21
#define Donut_time 15
#define Cake_time 14
#define Coriander_time 70
int MQ3_State = 0;
String command;
...
//    lcd.print("IN LIST");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Food_Plate_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Food_Plate_time);
       delay(1000);
  }
    }
    else
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Wine_Glass_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Wine_Glass_time);
       delay(1000);
  }
      ////lcd display item milk displat =true
    }
  ...
  //    BT.println("cold item");
   //   Serial.println("Cold_Coffe ");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Cold_Coffe_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Cold_Coffe_time);
       delay(1000);
  }
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Curry_bowl_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Curry_bowl_time);
       delay(1000);
  }
   ...
   //   BT.println(" Banana item");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Banana_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Banana_time);
       delay(1000);
  }
   ...
   //   BT.println("apple item");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Apple_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Apple_time);
       delay(1000);
  }
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Sandwich_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Sandwich_time);
       delay(1000);
  }
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Orange_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Orange_time);
       delay(1000);
  }
  ...
  //     Serial.println("Hotdog ");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Hotdog_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Hotdog_time);
       delay(1000);
  }
  ...
  //     Serial.println("Pizza ");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Pizza_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Pizza_time);
       delay(1000);
  }
   ...
   //   Serial.println("Donut");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Donut_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Donut_time);
       delay(1000);
  }
 ...
 //     BT.println("coriander item");
  //      Serial.println("Coriander");
    ...
    // turn LED on:
      ...
      lcd.setCursor(0, 0);
      lcd.print("CURRENT TIME:");
       lcd.print(Coriander_Count);
      lcd.setCursor(0, 1);
      lcd.print("EXP. TIME :");
      lcd.print(Coriander_time);
       delay(1000);
  }
