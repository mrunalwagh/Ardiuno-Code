...
void SendMessage()
{
  ...
  Serial.println("\n am sending msg ");
  msgSerial.println("AT+CMGS=\"+918766403908\"\r"); // Replace x with mobile number
...
//--------------------------------------------------------------F1
    ...
    //do gsm call  
        DialCall();
        showOnLCDGeneral("Doing call on","8766403908");
...
void DialCall()
{
    ...
    msgSerial.println("ATD+918766403908;");        // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
    delay(20000);
}
...
void SendMessageMotor(String msg)
{
  ...
  delay(1000);  // Delay of 1000 milli seconds or 1 second
  Serial.println("\n am sending msg ");
  msgSerial.println("AT+CMGS=\"+918766403908\"\r"); // Replace x with mobile number   anant 
