...
pinMode(led2PinRed, OUTPUT);  
    ...
    //---------------------------------------Serial Setup
    tmrpcm.speakerPin = 46; //5,6,11 or 46 on Mega, 9 on Uno, Nano, etc                                  //m5 chane 
    tmrpcm.setVolume(5);
  ...
  else                                                                                                           //m8
  {
    ...
    //-------------------------------------- rtc setup
        ...
        if (rtc.lostPower())
        {
            ...
            //  rtc.adjust(DateTime(2020, 27, 08, 10, 56, 00));
...
if(Distance_mm>=entryDoorStart and Distance_mm<=entryDoorEnd)   //direct         //case 2  76 to 23000  give beep
{
    //read entry count and update it 

     cntEntryWithoutTempCheck=eRead(eeAddressEntryWithoutTempCheck);
     cntEntryWithoutTempCheck=cntEntryWithoutTempCheck+1;
     eWrite(cntEntryWithoutTempCheck,eeAddressEntryWithoutTempCheck);
     Serial.println("\n----Entry without check");

     
 ///------------------------------------------------------------------------find difference of delay

   // funGiveBeep(2000);
     /*if delay is >7 sec)
     { 
          then give long beep to take them back
     }

   */  
     return( cntEntryWithoutTempCheck);
...
Serial.println("\n funAlaram under constrction");
 ...
 //------------------------------------write alaram count into eeprom
  cntAlaram=eRead(eeAddressAlaram);
  cntAlaram=cntAlaram+1;
    eWrite(cntAlaram,eeAddressAlaram);
    ...
    else 
    {
       ...
       //****
        ...
        digitalWrite(led1PinGreen,LOW);
            ...
            cntEntryWithTempCheck=eRead(eeAddressEntryWithTempCheck);
            cntEntryWithTempCheck=cntEntryWithTempCheck+1;
            eWrite(cntEntryWithTempCheck,eeAddressEntryWithTempCheck);
          //  cntEntryWithTempCheck=eRead(eeAddressEntryWithTempCheck);
...
void funPlayFile(int ch)
{
  ...
  Serial.println("am in playfile ");

 switch(ch)
 {
  case 80: Serial.println("playing file");
           tmrpcm.play("Eighty.wav");
           delay(3000); 
           break;
  case 81: Serial.println("playing file");
           tmrpcm.play("Eighty1.wav");
           delay(3000);
           break;
  case 82: Serial.println("playing file");
           tmrpcm.play("Eighty2.wav");
           delay(3000);
           break;
  case 83: Serial.println("playing file");
           tmrpcm.play("Eighty3.wav");
           delay(3000);
           break;
  case 84: Serial.println("playing file");
           tmrpcm.play("Eighty4.wav");
           delay(3000);
           break;
  case 85: Serial.println("playing file");
           tmrpcm.play("Eighty5.wav");
           delay(3000);
           break;
  case 86: Serial.println("playing file");
           tmrpcm.play("Eighty6.wav");
           delay(3000);
           break;
  case 87: Serial.println("playing file");
           tmrpcm.play("Eighty7.wav");
           delay(3000);
           break;
  case 88: Serial.println("playing file");
           tmrpcm.play("Eighty8.wav");
           delay(3000);
           break;
  case 89: Serial.println("playing file");
           tmrpcm.play("Eighty9.wav");
           delay(3000);
           break;
  case 90: Serial.println("playing file");
           tmrpcm.play("Ninety.wav");
           delay(3000);
           break;
  case 91:Serial.println("playing file");
          tmrpcm.play("Ninety1.wav"); 
          delay(3000);
          break;
  case 92:Serial.println("playing file");
          tmrpcm.play("Ninety2.wav"); 
          delay(3000);
          break;
  case 93:Serial.println("playing file");
          tmrpcm.play("Ninety3.wav"); 
          delay(3000);
          break;
  case 94:Serial.println("playing file");
          tmrpcm.play("Ninety4.wav"); 
          delay(3000);
          break;
  case 95:Serial.println("playing file");
          tmrpcm.play("Ninety5.wav"); 
          delay(3000);
          break;
 
  case 96: Serial.println("playing file");
          tmrpcm.play("Ninety6.wav"); 
          delay(3000);
          break;
  case 97: Serial.println("playing file");
          tmrpcm.play("Ninety7.wav"); 
          delay(3000);
          break;
  case 98:Serial.println("playing file");
          tmrpcm.play("Ninety8.wav"); 
          delay(3000);
          break;
  case 99:Serial.println("playing file");
          tmrpcm.play("Ninety9.wav"); 
          delay(3000);
          break;
  case 100:Serial.println("playing file");
           tmrpcm.play("Hundred.wav");
           delay(3000);
           break;
  case 101: Serial.println("playing file");
            tmrpcm.play("Hundred1.wav");
            delay(3000);
            break;
  case 102 :Serial.println("playing file");
            tmrpcm.play("Hundred2.wav");
            delay(3000);
            break;
  case 103: Serial.println("playing file");
            tmrpcm.play("Hundred3.wav");
            delay(3000);
            break;
  case 104: Serial.println("playing file");
            tmrpcm.play("Hundred4.wav");
            delay(3000);
            break;
  case 105: Serial.println("playing file");
            tmrpcm.play("Hundred5.wav");
            delay(3000);
            break;
  case 106: Serial.println("playing file"); 
            tmrpcm.play("Hundred6.wav");
            delay(3000);
            break;
  case 107: Serial.println("playing file");
            tmrpcm.play("Hundred7.wav");
            delay(3000);
            break;
  case 108: Serial.println("playing file");
            tmrpcm.play("Hundred8.wav");
            delay(3000);
            break;
  case 109: Serial.println("playing file");
            tmrpcm.play("Hundred9.wav");
            delay(3000);
            break;
  ...
  default:Serial.println("out of range");
          tmrpcm.play("Very High temp.wav");
          delay(3000); 
 } //end of switch
