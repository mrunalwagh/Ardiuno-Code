...
const int rs = 2, en =3, d4 = 4, d5 = 5, d6 = 6, d7 = 7;    //need to edit as per our requirement  *****(2,3,4,5,6,7);
...
//------------------------------------------RTC Setup
  ...
  if (rtc.lostPower())
  {
   ...
   // rtc.adjust(DateTime(2018, 20, 03, 02, 01, 00));
    //rtc.adjust(DateTime(2020,9,25,11,17,15));; //set current time and cut paiste same line outside of for loop
  }
  //rtc.adjust(DateTime(2022,10,17,21,22,15));   // to renter time *************************************************************
