...
*/
  ...
  //rtc.adjust(DateTime(2020,9,25,11,46,15));; //set current time and cut paiste same line outside of for loop
  }
  //rtc.adjust(DateTime(2020,9,28,10,35,15));;   // to renter time *************************************************************
