...
//--
    ...
    float TEMP=mlx.readObjectTempF()+12;
        ...
        { 
          ...
          digitalWrite(buzzer,LOW);
           delay(4000);
            ...
            digitalWrite(RLED,LOW);
        //  funShowOnLCD("Data sent"," to","Cloud"," Sucessfully");
          delay(500);
         }
      //-------------------------------------------------------time to hand sanitization manually
